...
- `IMPLEMENTADO`: harness documental base, reglas para agentes, fuentes de verdad, estructura de documentacion, ADRs iniciales, plan de implementacion por fases, bootstrap tecnico (Go, `chi`, servidor minimo, Docker Compose, Makefile), dominio y reglas centrales (entidades, roles, estados, transiciones, errores, tests unitarios).
