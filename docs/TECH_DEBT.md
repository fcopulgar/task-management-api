...
- **Duracion de token/sesion hardcodeada**: `DefaultTokenDurationHours = 24` y `DefaultSessionDuration = 24 * time.Hour` estan definidos como constantes en `internal/application/auth_usecase.go`. Seria deseable moverlos a configuracion de entorno para mayor flexibilidad operativa.
